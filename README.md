...
## 2. Demonstrating Model-View-Controller (MVC) Architecture Using HTML##
**Objective**: Create a simple website that conceptually represents the Model-View-Controller (MVC) architecture
using only HTML.
